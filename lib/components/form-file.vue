<template>
    ...
    <div :class="[custom?'custom-file':null, stateClass]"
...
<script>
    import { formCustomMixin, formMixin, formStateMixin } from '../mixins';
    import { from as arrayFrom } from '../utils/array';
    export default {
        mixins: [formMixin, formStateMixin, formCustomMixin],
        data() {
            return {
                selectedFile: null,
                dragging: false
