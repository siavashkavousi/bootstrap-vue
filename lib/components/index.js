...
import bDropdownItemButton from './dropdown-item-button.vue';
...
import bFormRadios from './form-radios.vue';
...
import bFormSelectOptgroup from './form-select-optgroup';
...
export {
    ...
    bFormSelect,
    bFormSelectOption,
    bFormSelectOption as bOption,
    bFormSelectOptgroup,
    bFormSelectOptgroup as bOptgroup,
    bJumbotron,
    bBadge,
    bMedia,
    bModal,
